...
## 1. Instalasi VM
![alt text](screenshots/instalasi_vm.png)
## 2. OS Running
![alt text](screenshots/os_guest_running.png.png)
## 3. Konfigurasi sebelum diubah
![alt text](screenshots/konfigurasi_resource_sebelum_ubah.png.png)
![alt text](screenshots/konfigurasi_resource_sebelum_ubah2.png.png)
## 4. Performa sebelum diubah
![alt text](screenshots/performa_konfigurasi_sebelum_diubah.png.png)
![alt text](screenshots/performa_konfigurasi_sebelum_diubah2.png.png)
## 5. Konfigurasi setelah diubah
![alt text](screenshots/konfigurasi_resource_setelah_ubah.png.png)
![alt text](screenshots/konfigurasi_resource_setelah_ubah2.png.png)
## 6. Performa setelah diubah
![alt text](screenshots/performa_konfigurasi_setelah_diubah.png.png)
![alt text](screenshots/performa_konfigurasi_setelah_diubah2.png.png)
